...
CREATE TABLE `comment`  (
  ...
  `type` int(4) NOT NULL,
  `commentator` int(4) NOT NULL,
  `gmt_create` bigint(50) NOT NULL,
  `gmt_modified` bigint(50) NOT NULL,
  `like_count` bigint(50) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES (1, '1', 'initDataBase table', 'SQL', 'V1__initDataBase_table.sql', 966571102, 'root', '2019-07-24 12:44:12', 196, 1);
...
-- Records of question
-- ----------------------------
INSERT INTO `question` VALUES (4, '发布问题测试', '发布问题测试内容', 1563635073254, 1563635073254, 1, 0005, 0054, 0025, '测试');
...
INSERT INTO `question` VALUES (12, '登录问题修复', '修改gitHub登录问题', 1563880927826, 1563880927826, 1, 0000, 0000, 0000, '修复登录');
INSERT INTO `question` VALUES (13, '24254', '2542542', 1563893700361, 1563893700361, 1, 0000, 0000, 0000, '2435444212');
INSERT INTO `question` VALUES (14, '34343', '4535434', 1563894279560, 1563894279560, 1, 0000, 0000, 0000, '3543543');
INSERT INTO `question` VALUES (15, 'lalalalaka', 'lalalalala', 1563895166810, 1563895166810, 1, 0000, 0000, 0000, 'lalalal');
INSERT INTO `question` VALUES (16, 'trter', 'tyreytr', 1563979465378, 1563979465378, 1, 0000, 0000, 0000, 'trytry');
INSERT INTO `question` VALUES (17, 'dsvdvfd', 'fvdvfdv', 1563981549148, 1563981549148, 1, 0000, 0000, 0000, 'fvdvdvf');
INSERT INTO `question` VALUES (18, 'test', 'saaaaaaaaaaaaaaaaaaaa', 1563984616589, 1563984616589, 1, NULL, NULL, NULL, 'sadddddddddddd');
